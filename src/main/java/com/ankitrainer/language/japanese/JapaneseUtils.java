...
public class JapaneseUtils {
     ...
     */
    private static final Map<String, Map<ConjugationType, String>> IRREGULAR_CONJUGATIONS = Map.of(
            ...
            "ある", createIrregularMap(
                    "あって", "あります", "ない", "ありません",
                    "あった", "ありました", "なかった", "ありませんでした"
            )
    );
    ...
    private static Map<ConjugationType, String> createIrregularMap(
            String te,
            String polite,
            String negative,
        ...
        return Map.of(
                JP_VERB_TE, te,
                JP_VERB_POLITE, polite,
                JP_VERB_NEGATIVE, negative,
                JP_VERB_NEGATIVE_POLITE, negativePolite,
                JP_VERB_PAST, past,
                JP_VERB_PAST_POLITE, pastPolite,
                JP_VERB_PAST_NEGATIVE, pastNegative,
                JP_VERB_PAST_NEGATIVE_POLITE, pastNegativePolite
        );
    }

    public static Map<ConjugationType, String> getIrregularConjugations(String verb) {
